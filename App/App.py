...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Hari4509@',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://netgineer.netlify.app/" style="text-decoration: none; color: #021659;">Beloved Team.</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>admin</b> as username and <b>{protected}</b> as password.<br/>
            It will load all the required stuffs and perform analysis.
        </p><br/><br/>

        <p align="justify">
            Built with 🤍 by 
            <a href="https://netgineer.netlify.app/" style="text-decoration: none; color: grey;">Beloved Team.</a> 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'admin' and ad_password == 'Hari4509@':
                ...
                st.success("Welcome Hariharan ! Total %d " % values + " User's Have Used Our Tool : )")                
